...
QwwRichTextEdit::QwwRichTextEdit(QWidget *parent) : QTextEdit(parent){
    ...
    m_actions[BoldAction] = new QAction(wwWidgets::icon("format-text-bold", QIcon(QPixmap(":/wwrichtextedit/images/win/textbold.png"))), "Bold", this);
    ...
    m_actions[ItalicAction] = new QAction(wwWidgets::icon("format-text-italic", QPixmap(":/wwrichtextedit/images/win/textitalic.png")), "Italic", this);
    ...
    m_actions[UnderlineAction] = new QAction(wwWidgets::icon("format-text-underline", QPixmap(":/wwrichtextedit/images/win/textunder.png")), "Underline", this);
    ...
    al = new QAction(wwWidgets::icon("format-justify-left", QPixmap(":/wwrichtextedit/images/win/textleft.png")), "Align left", this);
    ar = new QAction(wwWidgets::icon("format-justify-right", QPixmap(":/wwrichtextedit/images/win/textright.png")), "Align right", this);
    ac = new QAction(wwWidgets::icon("format-justify-center", QPixmap(":/wwrichtextedit/images/win/textcenter.png")), "Center", this);
    aj = new QAction(wwWidgets::icon("format-justify-fill", QPixmap(":/wwrichtextedit/images/win/textjustify.png")), "Justify", this);
