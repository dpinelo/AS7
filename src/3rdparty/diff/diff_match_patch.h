...
public:
     ...
     */
    Diff(DiffCode::Operation _operation, const QString &_text);
    Diff();
    ...
    static QString strOperation(DiffCode::Operation op);
};
...
public:
    ...
    /** dpinelo: Comparamos líneas */
    QList<Diff> diff_main_lines(const QString &text1, const QString &text2);
...
public:
     ...
     */
private:
    static __inline QString safeMid(const QString &str, int pos)
    {
     ...
     */
private:
    static __inline QString safeMid(const QString &str, int pos, int len)
    {
