                ...
                if ( m_autogeneratedWidgets )
                {
                    ...
                    if ( cb != NULL )
                    {
                        ...
                        if ( cb->currentIndex() == BETWEEN_ELECTION_INDEX )
                        {
                            ...
                            {
                                QWidget *widget2 = q_ptr->findChild<QWidget *>(QString("db_%1_2").arg(propertyFieldName.toString()));
                                if ( widget2 != NULL )
                                {
                ...
                else
                {
                    ...
                    if ( wid != NULL )
                    {
                        ...
                        for ( int i = 0 ; i < widgets.size() ; i++ )
                        {
                            ...
                            if ( property2FieldName.isValid() && widget != widgets.at(i) && propertyFieldName.toString() == property2FieldName.toString() )
                            {
