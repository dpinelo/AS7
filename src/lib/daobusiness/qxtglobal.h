...
public:
    virtual ~QxtPrivate()
    {}
    __inline void QXT_setPublic(PUB* pub)
    {
        qxt_p_ptr = pub;
    }
...
protected:
    ...
    __inline const PUB& qxt_p() const
    {
        return *qxt_p_ptr;
    }
...
public:
    ...
    __inline void setPublic(PUB* pub)
    {
        pvt->QXT_setPublic(pub);
    }
    __inline PVT& operator()()
    {
        return *static_cast<PVT*>(pvt);
    }
    __inline const PVT& operator()() const
    {
        return *static_cast<PVT*>(pvt);
    }
private:
