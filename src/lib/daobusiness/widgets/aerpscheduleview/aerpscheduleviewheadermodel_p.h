...
#ifndef AERPSCHEDULEVIEWHEADERMODEL_P_H_INCLUDED
#define AERPSCHEDULEVIEWHEADERMODEL_P_H_INCLUDED
...
class AERPScheduleViewHeaderModel : public QAbstractTableModel
{
    Q_OBJECT
...
private:
    QPointer<AERPScheduleView> m_dataSource;
