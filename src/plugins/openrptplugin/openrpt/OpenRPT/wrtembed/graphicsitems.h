...
class ORGraphicsFieldItem : public ORGraphicsRectItem
{
  public:
    ...
    // dpinelo: ------------------------------------------
    bool alephERPFormat() const
    {
        return _alephERPFormat;
    }
    QString alephERPFormatString() const
    {
        return _alephERPFormatString;
    }
    void setAlephERPFormat(const QString &str);
    // dpinelo: ------------------------------------------
  ...
  protected:
    ...
    bool    _leftToRight;
    // dpinelo: -----------------------------------------
    bool    _alephERPFormat;
    QString _alephERPFormatString;
    // dpinelo: -----------------------------------------
};
