...
static __inline double convertToDouble(const std::string & s)
{
...
// lower case a string
static __inline std::string strlower(const std::string &cs) {
    std::string s = cs;
...
// trim from start
static __inline std::string ltrim(const std::string &cs) {
    std::string s = cs;
...
// trim from end
static __inline std::string rtrim(const std::string &cs) {
    std::string s = cs;
...
// trim from both ends
static __inline std::string trim(const std::string &s) {
