...
public:
    __inline QSnippet(const QSnippetPatternLoader *pl) : m_patternLoader(pl) {}
    virtual ~QSnippet() {}

    __inline QString name() const
    {
        return m_name;
    }
    __inline void setName(const QString& n)
    {
        m_name = n;
    }

    __inline QStringList contexts() const
    {
        return m_contexts;
    }
    __inline void setContexts(const QStringList& l)
    {
        m_contexts = l;
    }

    __inline QString pattern() const
    {
        return m_pattern;
    }

    __inline void setPattern(const QString& p)
    {
        m_pattern = p;
