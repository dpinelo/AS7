...
public:
    ...
    __inline int maxMarksPerLine() const
    {
        return m_maxMarksPerLine;
    }

    __inline bool hasMarks() const
    {
    ...
    __inline QDocumentIterator begin()
    {
        return m_lines.begin();
    }
    __inline QDocumentIterator end()
    {
        return m_lines.end();
    }

    __inline QDocumentConstIterator constBegin() const
    {
        return m_lines.constBegin();
    }
    __inline QDocumentConstIterator constEnd() const
    {
