...
class Q_ALEPHERP_EXPORT LanguageResourceDialog : public QDialog
{
    Q_OBJECT
...
class Q_ALEPHERP_EXPORT IconSelector: public QWidget
{
    Q_OBJECT
public:
...
class Q_ALEPHERP_EXPORT IconThemeEditor : public QWidget
{
    Q_OBJECT
